    ...
    <div class="main-content">
        <div class="table-container">
            ...
            <div class="search-container">
              <form action="{{ route('submissions') }}" method="get" class="flex items-center">
            ...
            <table>
                ...
                <tbody>
                    <!-- Example of how the rows would look for alumni data -->
                    ...
                    <tr>
                        ...
                        <td>{{ $scholar->email }}</td>
                        <td>{{ $scholar->yearLevel->year_level }}</td>
                        ...
                        <td>
                            <div class="btns">
                                ...
                                <!-- Delete Scholar -->
                                <form action="{{ route('scholars.updateStatus', $scholar->id) }}" method="POST">
                                  @csrf
                                  @method('PATCH')
                                  <select name="status" onchange="this.form.submit()">
                                      <option value="pending" {{ $scholar->status == 'pending' ? 'selected' : '' }}>Pending</option>
                                      <option value="approved" {{ $scholar->status == 'approved' ? 'selected' : '' }}>Approved</option>
                                      <option value="rejected" {{ $scholar->status == 'rejected' ? 'selected' : '' }}>Rejected</option>
                                  </select>
                              </form>
                            </div>
                        </td>
                ...
                @empty
                    <tr>
                        <td colspan="7">No scholars found.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
